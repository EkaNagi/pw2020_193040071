  ...
  <div class="buatform">
    <form action="" method="POST" class="form-inline">
      <div class="form-group mx-auto mb-2">
        <input type="text" class="form-control keyword" name="keyword" id="keyword" placeholder="Pencarian" autocomplete="off" autofocus>
        <button class="btn btn-dark ml-2 tombol-cari" type="submit" name="cari">Cari</button>
      </div>
    </form>
  </div>
  <div class="container">
